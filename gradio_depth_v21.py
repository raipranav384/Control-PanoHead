...
model_name = 'control_v11p_sd21_depth'
model = create_model(f'./models/control_v11p_sd21_normalbae.yaml').cpu()
model.load_state_dict(load_state_dict('./models/dreambooth_ckpt/dreambooth_ukj_pops.ckpt', location='cuda'), strict=False)
