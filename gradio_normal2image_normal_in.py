...
# model.load_state_dict(load_state_dict('./models/face_segment_sd_21.ckpt', location='cuda'))
model.load_state_dict(load_state_dict('./models/yogi.pth', location='cuda'))
# model.load_state_dict(load_state_dict('./models/model_control.ckpt', location='cuda'))
