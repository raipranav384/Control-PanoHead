...
####sd_model_path = '/home/sollid/Res23/dream/stable_diffusion_weights/popseo_sdv15/800/model.ckpt'
sd_model_path = './models/photoreal.ckpt'
model.load_state_dict(load_state_dict(f'{sd_model_path}', location='cuda'), strict=False)
